...
- Environment setup, API keys, Keyless flow and make sure no enviroment varibles/API keys are located in client side code. Keep them in env files
...
- Make sure that when the user creates a new account, a new user is created and added to the Database using prisma queries and send password as null.
