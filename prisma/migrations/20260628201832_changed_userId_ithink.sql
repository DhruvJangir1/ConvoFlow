...
CREATE TABLE public.Notifications (
  ...
  CONSTRAINT fk_notifications_id_bridge FOREIGN KEY (entity_id) REFERENCES public.AddFriendRequests(id),
...
CREATE TABLE public.AnonymousChatMessages (
  ...
  sender_id uuid NOT NULL DEFAULT 'ae04f9eb-8b90-4bf4-a949-75eca66139e4'::uuid,
