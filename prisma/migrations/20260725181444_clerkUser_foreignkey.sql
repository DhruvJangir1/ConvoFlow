...
CREATE TABLE public.USERS (
  ...
  CONSTRAINT fk_users_clerk_id FOREIGN KEY (clerk_id) REFERENCES public.clerkUsers(clerk_id),
  CONSTRAINT fk_users_email FOREIGN KEY (email) REFERENCES public.clerkUsers(email)
);
...
CREATE TABLE public.AnonymousChatMessages (
  ...
  CONSTRAINT AnonymousChatMessage_SenderId_fkey FOREIGN KEY (sender_id) REFERENCES public.USERS(id)
);
...
CREATE TABLE public.AnonymousChatMessagesUserVotes (
  ...
  CONSTRAINT AnonymousChatMessageVotes_fkey FOREIGN KEY (user_id) REFERENCES public.USERS(id),
  CONSTRAINT AnonymousChatMessage_VotesMessageId_fkey FOREIGN KEY (message_id) REFERENCES public.AnonymousChatMessages(id)
);
CREATE TABLE public.clerkUsers (
  clerk_id text NOT NULL DEFAULT ''::text,
  email text NOT NULL UNIQUE,
  CONSTRAINT clerkUsers_pkey PRIMARY KEY (clerk_id)
);